...
const sampleSubmissions = [
  {
    ...
    data: [
      {
        id: "field1",
        name: "Nội dung phê duyệt",
        value: "Mua thiết bị văn phòng",
        field_type: "TEXT",
      },
      {
        id: "field2",
        name: "Trong hay ngoài budget",
        value: "option1",
        field_type: "SINGLE_CHOICE",
      },
      {
        id: "field3",
        name: "Số tiền cần chi",
        value: "5000000",
        field_type: "NUMBER",
      },
    ],
...
export default function WorkflowPage() {
  ...
  const parentMenu = menusData?.find(
    (menu: any) => menu.id === currentSubmenu?.parent_id,
  );
  ...
  return (
    <MainLayout
      title={t(
        "submission.createTitle",
        currentSubmenu?.name || "Phê duyệt tài chính",
      )}
    >
        ...
        <Card>
          ...
          <CardContent className="px-6 py-4">
            ...
            <div className="flex flex-wrap gap-2 my-4">
              <Button
                variant="outline"
                className="text-xs bg-background hover:bg-primary/5 transition-colors text-foreground"
              >
                Nội dung phê duyệt
              </Button>
              <Button
