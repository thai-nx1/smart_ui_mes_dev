  ...
  (
    ...
    const contextValue = React.useMemo<SidebarContext>(
      () => ({
        ...
        open,
        setOpen,
        isMobile: !!isMobile, // Chắc chắn là boolean
        openMobile,
        setOpenMobile,
        toggleSidebar,
      }),
      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper min-h-svh w-full text-sidebar-foreground has-[[data-variant=inset]]:bg-sidebar",
              className
            )}
            ref={ref}
            {...props}
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-slate-900 text-gray-400 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-slate-700 group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "data-[active=true]:bg-cyan-900 data-[active=true]:text-cyan-500 data-[active=true]:font-medium dark:text-gray-400",
...
const SidebarGroupTrigger = React.forwardRef<
  HTMLButtonElement,
  React.ComponentProps<"button">
>(({ className, ...props }, ref) => {
  const { toggleSidebar } = useSidebar()
